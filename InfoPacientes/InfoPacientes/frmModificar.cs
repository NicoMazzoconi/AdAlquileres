...
namespace InfoPacientes
{
	public partial class frmModificar : Form
	{
		...
		public frmModificar(List<Persona> personas, Persona paciente)
		{
			InitializeComponent();
			lsPersona = personas;
		...
		{
			textBox1.Text = paciente.Nombre;
			textBox2.Text = paciente.Apellido;
			textBox3.Text = paciente.Dni.ToString();
			textBox4.Text = paciente.Telefono.ToString();
			textBox5.Text = paciente.Direccion;
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				if (a == newPerson && a != paciente)
				{
					esta = true;
					MessageBox.Show("Ya existe este dni en la base de datos", "Paciente repetido", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
					break;
				}
			}
			...
			if (!esta)
			{
				...
				paciente.Apellido = textBox2.Text;
				paciente.Dni = double.Parse(textBox3.Text);
				paciente.Telefono = double.Parse(textBox4.Text);
				paciente.Direccion = textBox5.Text;
				this.Close();
			}
